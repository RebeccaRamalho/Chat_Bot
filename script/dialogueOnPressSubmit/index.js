...
function botAnsweringToInputVal(e) {
  ...
  if (
    ...
    //SCOLARITY
      ...
      experienceDetails = `-En <b>2018</b> J'ai obtenu une licence en philosophie et un certificat en sociologie qui m'ont permis de structurer ma réflexion par l'exercice de la dissertation et de développer ma capacité d'introspection et d'ouverture d'esprit.<br>-En <b>2020 Social builder</b> puis <b>Simplon</b> en <b>2021</b> m'ont donné l'opportunité de développer des compétences dédiées à la <b>programmation web</b>.<br> J'ai par ces expériences pu développer des compétences telles que entre autres le maquettage d'une application, la capacité à développer le front end d'une application via le <b>framework React</b>, la capacité à développer la partie <b>back-end</b> d'une application grâce à Node.js, la capacité à faire de la veille et à documenter mon code.<br>En <b>2021</b> J'ai fait une année en d'alternance (toujours auprès de Simplon) en conception et développement d'appications.`;
    }
